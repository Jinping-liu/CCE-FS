...
if __name__ == '__main__':
    with open("E:\yan\XAI\py\SFE-CF\dataset\statlog\mapping.json", "r") as f:
        mapping = json.loads(f.read())

    raw_dataset = pd.read_csv(r"E:\yan\XAI\py\SFE-CF\cf\feature_select\dataset\statlog\row_statlog\statlog.csv")
    ...
    dataset = pd.read_csv(r"E:\yan\XAI\py\SFE-CF\cf\feature_select\dataset\statlog\processed_statlog\processed_statlog.csv")
    ...
    # load model
    model = tf.keras.models.load_model(r'E:\yan\XAI\py\SFE-CF\cf\feature_select\dataset\statlog\pred_model\statlog_DNN.h5')
    ...
    kd_tree = GeneratePopulationWithKmeans(black_model, raw_train_dataset, 100, mapping, n_clusters=50,
                                           random_state=0,
                                           pipeline_path=r"E:\yan\XAI\py\SFE-CF\cf\feature_select\dataset\statlog\.pkl\statlog_pipeline.pkl")
    ...
    df_original.to_csv(f"./dataset/statlog/predict_samples_version_1_100_IWFM_count(100,2).csv",
                       index=False)
    df_cf.to_csv(f"./dataset/statlog/counterfactual_samples_version_1_100_IWFM_count(100,2).csv",
                 index=False)
