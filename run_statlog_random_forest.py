...
if __name__ == '__main__':
    with open("E:\yan\XAI\py\SFE-CF\dataset\statlog\mapping_random_forest.json", "r") as f:
        mapping = json.loads(f.read())

    raw_dataset = pd.read_csv(r"E:\yan\XAI\py\SFE-CF\cf\feature_select\dataset\statlog\row_statlog\statlog_random_forest.csv")
    ...
    dataset = pd.read_csv(r"E:\yan\XAI\py\SFE-CF\cf\feature_select\dataset\statlog\processed_statlog\processed_statlog_random_forest.csv")
    ...
    # load model
    model = tf.keras.models.load_model(r'E:\yan\XAI\py\SFE-CF\cf\feature_select\dataset\statlog\pred_model\statlog_random_forest_DNN.h5')
    ...
    k = 1
    kd_tree = GeneratePopulationWithKmeans(black_model, raw_train_dataset, 50, mapping, n_clusters=50,
                                           random_state=0,
                                           pipeline_path=r"E:\yan\XAI\py\SFE-CF\cf\feature_select\dataset\statlog\.pkl\statlog_pipeline_random_forest.pkl")
    ...
    for index, series_data in y_pred_original_dataset.iterrows():
        ...
        while True and repeat_count <= 2:
            ...
            algorithm = NSGA2(pop_size=50, sampling=pop,
    ...
    df_original.to_csv(r"E:\yan\XAI\py\SFE-CF\results\statlog_random_forest\predict_samples_version_1_100_IWFM_count.csv",
                       index=False)
    df_cf.to_csv(r"E:\yan\XAI\py\SFE-CF\results\statlog_random_forest\counterfactual_samples_version_1_100_IWFM_count.csv",
                 index=False)
